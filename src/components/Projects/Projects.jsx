...
export function Projects() {
    ...
    return (
        <section
            className="w-full h-full xs:py-5 bg-primaryColor flex flex-col items-center justify-start"
            id="Projetos"
        >
            <h2 className="md:text-4xl xs:text-2xl font-bold xs:mt-48">
            ...
            <div className="w-full flex items-center justify-center">
                <a
                    href="https://github.com/nicolasfreitas-dev?tab=repositories"
                    target="_blank"
                >
                    <button
